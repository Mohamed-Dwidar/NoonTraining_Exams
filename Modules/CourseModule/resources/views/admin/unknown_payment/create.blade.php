                            ...
                            <div class="row">
                                <div class="col-lg-12 col-12">
                                    <form class="card-form side-form" method="POST"
                                        action='{{ route(Auth::getDefaultDriver().'.unknown_payment.store') }}' enctype="multipart/form-data">
                                        @csrf
                                            ...
                                            <div class="col-lg-3 col-sm-12 col-xs-12 col-2">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" class="form-control" id="transferor_name"
                                                        name="transferor_name" value="{{ old('transferor_name') }}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-2 col-sm-12 col-xs-12 col-2">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" class="form-control hijri-datepicker"  id="paid_at"
                                            ...
                                            <div class="col-lg-2 col-sm-12 col-xs-12 col-2">
                                                ...
                                                <div class="form-group">
                                                    <select id="pay_method" name="pay_method" class="form-control">
                                                        <option value="كاش" @if(old('pay_method') == 'كاش') selected  @endif>كاش</option>
                                                        <option value="تحويل" @if(old('pay_method') == 'تحويل') selected  @endif>تحويل</option>
                                                        <option value="شبكة" @if(old('pay_method') == 'شبكة') selected  @endif>شبكة</option>
                                                        <option value="تابي" @if(old('pay_method') == 'تابي') selected  @endif>تابي</option>
                                                        <option value="تمارا" @if(old('pay_method') == 'تمارا') selected  @endif>تمارا</option>
                                                        <option value="يور واي" @if(old('pay_method') == 'يور واي') selected  @endif>يور واي</option>
                                                        <option value="أخرى" @if(old('pay_method') == 'أخرى') selected  @endif>أخرى</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
