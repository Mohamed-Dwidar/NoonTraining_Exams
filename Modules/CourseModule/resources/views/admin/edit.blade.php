                            ...
                            <div class="row">
                                <div class="col-lg-12 col-12">
                                    <form class="card-form side-form" method="POST"
                                        action='{{ route(Auth::getDefaultDriver() . '.courses.update') }}'
                                                            ...
                                                            @if (!empty($branches))
                                                                @foreach ($branches as $branch)
                                                                    <option value="{{ $branch->id }}"
                                                                        @if (old('branch_id', $course->branch_id) == $branch->id) selected @endif>
                                                                        {{ $branch->name }}</option>
                                                                @endforeach
                                                            @endif
                                                        </select>
                                            ...
                                            <div class="col-lg-2 col-sm-12 col-xs-12 col-2">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" class="form-control" id="group_nu"
                                                        name="group_nu" value="{{ old('group_nu', $course->group_nu) }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3 col-sm-12 col-xs-12 col-3">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" class="form-control" id="course_org_nu"
                                                        name="course_org_nu"
                                                        value="{{ old('course_org_nu', $course->course_org_nu) }}">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-lg-2 col-sm-12 col-xs-12 col-2">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" class="form-control hijri-datepicker"
                                                        ...
                                                        value="{{ old('start_at', $course->start_at) }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2 col-sm-12 col-xs-12 col-2">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" class="form-control hijri-datepicker"
                                                        ...
                                                        value="{{ old('end_at', $course->end_at) }}">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-lg-2 col-sm-12 col-xs-12 col-2">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" class="form-control" id="exam_fees"
                                                        name="exam_fees" value="{{ old('exam_fees', $course->exam_fees) }}">
                                                </div>
                                            </div>
                                        </div>
