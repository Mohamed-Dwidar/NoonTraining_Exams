...
class UnknownPaymentAdminController extends Controller
{
    ...
    public function assignPayment(Request $request)
    {
        ...
        return redirect()->route('admin.unknown_payment.list')->with('success', 'تمت العملية بنجاح.');
    }
    ...
    // {
    //     // Call the service to get the course registrations with related students
    //     $students = $this->courseRegService->getStudentsForCourse($courseId);
    //     dd($students->courses_regs);
