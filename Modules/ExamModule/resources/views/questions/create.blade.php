                                    ...
                                    <form class="card-form side-form" method="POST"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3 col-sm-12 col-xs-12 col-6">
                                                ...
                                                <div class="form-group">
                                                    <input type="number" class="form-control" id="total_questions"
                                                        name="total_questions" value="{{ old('total_questions') }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3 col-sm-12 col-xs-12 col-6">
                                                ...
                                                <div class="form-group">
                                                    <input type="number" class="form-control" id="mcq_count" name="mcq_count"
                                                        value="{{ old('mcq_count') }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3 col-sm-12 col-xs-12 col-6">
                                                ...
                                                <div class="form-group">
                                                    <input type="number" class="form-control" id="true_false_count"
                                                        name="true_false_count" value="{{ old('true_false_count') }}">
                                                </div>
                                            </div>
                                        </div>
